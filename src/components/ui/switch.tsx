  ...
  (
    ...
    >
      <SwitchPrimitives.Thumb
        className={cn(
          "pointer-events-none  h-5 w-5 items-center flex rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0"
        )}
      >
